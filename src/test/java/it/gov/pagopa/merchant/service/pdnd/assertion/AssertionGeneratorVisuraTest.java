...
class AssertionGeneratorVisuraTest {
    ...
    void generateClientAssertion_validInput_returnsJwtToken() throws Exception {
        ...
        try (MockedStatic<KeyGenerator> mockedStatic =
            ...
            mockedStatic
                    .when(() -> KeyGenerator.getPrivateKey("privateKey"))
                    .thenReturn(privateKey);

            String token = assertionGeneratorVisura.generateClientAssertion(
                    jwtCfg,
                    "privateKey"
            );
            ...
            assertEquals("audience", jwt.getAudience().get(0));
    ...
    void generateClientAssertion_keyGeneratorThrowsException_propagatesException() {
        ...
        try (MockedStatic<KeyGenerator> mockedStatic =
            ...
            mockedStatic
                    .when(() -> KeyGenerator.getPrivateKey("invalid"))
                    .thenThrow(
            ...
            IllegalArgumentException exception = assertThrows(
                    ...
                    () -> assertionGeneratorVisura.generateClientAssertion(
                            jwtCfg,
                            "invalid"
                    )
            );
