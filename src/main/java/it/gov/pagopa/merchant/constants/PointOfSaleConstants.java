...
public final class PointOfSaleConstants {
    ...
    public static final String CODE_EMAIL_ALREADY_REGISTERED = "CODE_EMAIL_ALREADY_REGISTERED";
    public static final String CODE_POS_ALREADY_REGISTERED_OTHER_INITIATIVE = "CODE_POS_ALREADY_REGISTERED_OTHER_INITIATIVE";
    public static final String CODE_ONLINE_POS_ALREADY_REGISTERED = "CODE_ONLINE_POS_ALREADY_REGISTERED";
    public static final String CODE_PHYSICAL_POS_ALREADY_REGISTERED = "CODE_PHYSICAL_POS_ALREADY_REGISTERED";
    // ===GENERIC MESSAGES===
