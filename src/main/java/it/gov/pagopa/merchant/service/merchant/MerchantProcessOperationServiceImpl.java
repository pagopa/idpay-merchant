...
public class MerchantProcessOperationServiceImpl implements MerchantProcessOperationService{
    ...
    public void processOperation(QueueCommandOperationDTO queueCommandOperationDTO) {
        ...
        if (MerchantConstants.OPERATION_TYPE_DELETE_INITIATIVE.equals(queueCommandOperationDTO.getOperationType())) {
            ...
            List<Initiative> deletedMerchant = merchantRepository.deleteByInitiativeId(queueCommandOperationDTO.getOperationId());
            ...
            log.info("[DELETE_MERCHANT] Deleted {} initiative {} on merchant", deletedMerchant.size(),
            ...
            //deletedMerchant.forEach(mId -> auditUtilities.logDeleteMerchant(mId, queueCommandOperationDTO.getOperationId()));
